...
int CALLBACK CSortedListCtrl::CallbackCompareItems(LPARAM lParam1, LPARAM lParam2, LPARAM lParam3)
{
	...
	return pSortedList->CompareItems (lParam1, lParam2);
}
...
int CSortedListCtrl::CompareItems(LPARAM lParam1, LPARAM lParam2)
{
	return 0;
}
...
void CSortedListCtrl::OnEnable(BOOL bEnable) 
{
	CListCtrl::OnEnable(bEnable);
	
	m_HeaderCtrl.EnableWindow( bEnable );
}

void CSortedListCtrl::GreyedDisabledHeader(BOOL bGreyed)
{
	m_HeaderCtrl.SetGreyableHeader( bGreyed );
}
