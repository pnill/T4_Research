...
// 
// The DSTAT_EXTERN(s) and PSTAT_EXTERN(s) macros should be placed in *.h 
// files to expose stats to external modules when so desired.
// 
///////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////
// LOW LEVEL MACRO IMPLEMENTATIONS
///////////////////////////////////////////////////////////////////////////

#define STAT_SetValue(S,V)                                          \
{                                                                   \
    S.Value = V;                                                    \
...
#define STAT_ClearMinMax(S)                                         \
{                                                                   \
    S.Min = S.Value;                                                \
    S.Max = S.Value;                                                \
}

#define STAT_GetValue(S)     S.Value
#define STAT_GetMin(S)       S.Min
#define STAT_GetMax(S)       S.Max
