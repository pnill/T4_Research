...
public:
	...
	int		GetSelectedMotions( CMotion** pMotionList, int MaxCount );
...
// Dialog Data
	...
	CButton	m_ExportDefault;
	CButton	m_Quaternion;
	CButton	m_ExportQuatW;
...
protected:
	...
	afx_msg void OnEditmotion();
	afx_msg void OnQuaternionOn();
	afx_msg void OnExportquatwOn();
	afx_msg void OnExportdefault();
	afx_msg void OnMotionImport();
	//}}AFX_MSG
