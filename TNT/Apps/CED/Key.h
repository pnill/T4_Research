...
public:
	...
	vector3 		m_Vector ;											// Vector at Position
	vector3 		m_Rotation ;										// Rotation at Position
...
public:
	...
	void		SetPosition				( vector3  *pv ) ;
	void		GetPosition				( vector3  *pv ) ;

	void		SetVector				( vector3  *pv ) ;
	void		GetVector				( vector3  *pv ) ;
	
	void		SetRotation				( vector3  *pv ) ;
	void		GetRotation				( vector3  *pv ) ;
