...
//#include <iostream.h> //used for M4 output
...
f64     x_ceil          ( f64 a              );
#else
// can't get the x functions to work on the PC/XBOX
...
friend  radian3     operator *  ( f32 Scalar, const radian3& R );
		...
		void		XYZ_to_ZXY	( void );
		void		XYZ_to_XZY	( void );
		void		XZY_to_XYZ	( void );
		void		ZXY_to_XYZ	( void );
...
//
		...
		void		ZToVecRot	( radian* Rx, radian* Ry );
		void		VecToZRot	( radian* Rx, radian* Ry );
...
//
        ...
        radian3     GetRotationXYZ  ( void ) const;
        void        SetRotation     ( const radian3& Rotation );
		void		SetRotationXYZ	( const radian3& Rotation );
        void        Rotate          ( const radian3& Rotation );
        void        RotateXYZ       ( const radian3& Rotation );
        void        PreRotate       ( const radian3& Rotation );
        void        PreRotateXYZ    ( const radian3& Rotation );
        void        RotateX         ( radian Rx );
        void        RotateY         ( radian Ry );
        void        RotateZ         ( radian Rz );
...
//  BlendLinear(Qa,Qb,T)     - Interpolates from Qa to Qb linearly between the range of T[0,1].
//
////////////////////////////////////////////////////////////////////////////
//
...
//
		...
		void		Get				( f32& fX, f32& gY, f32& fZ, f32& fW );
        void        Identity        ( void );
        void        Zero            ( void );
        void        SetupMatrix     ( const matrix4& Matrix   );
        void        SetupRotate     ( const radian3& Rotation );
        void        SetupRotateXYZ  ( const radian3& Rotation );
        void        SetupPreRotate  ( const radian3& Rotation );
        void        SetupPreRotateXYZ( const radian3& Rotation );
...
friend  quaternion  BlendLinear     ( const quaternion& Qa, const quaternion& Qb, f32 T );
};
