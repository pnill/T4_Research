...
inline radian3 matrix4::GetRotationXYZ( void ) const
{
	radian3 Rotation;
    radian X, Y, Z;
    f32    s, cy;
    ...
    if ((cy > 0) || (cy < 0))
    {
        X = (f32)x_atan2( M[1][2], M[2][2] );
        Z = (f32)x_atan2( M[0][1], M[0][0] );
    }
    else
    {
        X = (f32)x_atan2( -M[2][1], M[1][1] );
        Z = 0;
    }
...
inline void matrix4::SetRotationXYZ( const radian3& Rotation )
{
    f32 sx, cx;
    f32 sy, cy;
    f32 sz, cz;
...
inline void matrix4::RotateXYZ( const radian3& Rotation )
{
    matrix4 aM;
    aM.SetRotationXYZ( Rotation );
    *this = aM * *this;    
}

//==========================================================================

inline void matrix4::PreRotateXYZ( const radian3& Rotation )
{
    matrix4 aM;    
    aM.SetRotationXYZ( Rotation );
    *this *= aM;
