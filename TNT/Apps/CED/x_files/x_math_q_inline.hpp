...
inline void	quaternion::Set( f32 fX, f32 fY, f32 fZ, f32 fW )
{
	X = fX;
	Y = fY;
	Z = fZ;
...
inline void	quaternion::Get( f32& fX, f32& fY, f32& fZ, f32& fW )
{
	fX = X;
	fY = Y;
	fZ = Z;
...
inline void quaternion::SetupRotateXYZ( const radian3& Rotation )
{
	Identity();
    RotateX( Rotation.Pitch );
    RotateY( Rotation.Yaw );
...
inline void quaternion::RotateXYZ( const radian3& Rotation )
{
    quaternion Q;
    Q = *this;
    Q.RotateX( Rotation.Pitch );
...
inline void quaternion::PreRotateXYZ( const radian3& Rotation )
{
    quaternion Q;
    Q = *this;
    PreRotateZ( Rotation.Roll );
...
inline void quaternion::SetupPreRotateXYZ( const radian3& Rotation )
{
    PreRotateZ( Rotation.Roll );
    PreRotateY( Rotation.Yaw );
    PreRotateX( Rotation.Pitch );
...
{
    PitchYaw( Q * vector3(0,0,1), Pitch, Yaw );
}
...
inline quaternion BlendLinear( const quaternion& Qa, const quaternion& Qb, f32 T )
{
    quaternion Q;
    quaternion QT0;
    quaternion QT1;
