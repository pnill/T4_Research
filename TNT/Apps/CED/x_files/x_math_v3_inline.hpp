...
inline void vector3::ZToVecRot( radian* Rx, radian* Ry )
{
    f32 L;
    ...
    L   = (f32)x_sqrt( this->X * this->X + this->Z * this->Z );

    *Ry = (f32) x_atan2( this->X, this->Z );
    *Rx = (f32)-x_atan2( this->Y, L );
} 

//==========================================================================

inline void vector3::VecToZRot( radian* Rx, radian* Ry )
{
    ASSERT(Rx);
    ASSERT(Ry);

    this->ZToVecRot( Rx, Ry );
    *Rx = - *Rx;
    *Ry = - *Ry;
}
