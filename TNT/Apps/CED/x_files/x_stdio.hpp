...
#define	X_STATUS_CANCELLED		6
#define	X_STATUS_CANCELPENDING	7
...
////////////////////////////////////////////////////////////////////////////
//
//  x_freada        - Asynchronous file read based on Size and Count.
//  x_freadastatus  - Returns the status of the task with the specified ID.
//
////////////////////////////////////////////////////////////////////////////
...
//---	When a task is canceled, the code should wait for the x_freadastatus
//		to return X_STATUS_NOTFOUND to know that the task is complete
...
////////////////////////////////////////////////////////////////////////////
//
//  x_fread_setup   - Sets the x_fread() function to use default behaviour
//                    or to use an asynchronous read internally.
////////////////////////////////////////////////////////////////////////////
enum FREAD_OPTION
{
    FREAD_DEFAULT       = 0,
...
void    x_fread_setup( FREAD_OPTION );
...
s32     x_vsprintf  ( char* pStr,   const char* pFormatStr, va_list Arg );
...
char*   vfs  ( const char* pFormatStr, va_list Args );
...
typedef void	(*cancel_fnptr) ( s32 TaskID );
