...
QPCRipSkin::QPCRipSkin( void )
{
    ...
    if( gfp == NULL )
    {
        gfp = x_fopen( "PCRipSkinOutput.txt", "w" );
        ASSERT( gfp );
    }
}
...
//=====================================================================================================================================
void QPCRipSkin::SetSkinName( char* Name )
{
...
//=====================================================================================================================================
void QPCRipSkin::AddBone( char* Name )
{
    PCSkinBone* pTempBonePointer = NULL;

    // Allocate the memory to add the extra bone to the skin file.
    pTempBonePointer = (PCSkinBone*)x_realloc( mpBone, sizeof( PCSkinBone ) * (mNBones + 1));
...
//=====================================================================================================================================
void QPCRipSkin::NewTexture( char* TexturePath, s32 Width, s32 Height )
{
    PCSkinTexture* pTempTexture = NULL;
    ...
    pTempTexture = (PCSkinTexture*)x_realloc( mpTexture, sizeof( PCSkinTexture ) * (mNTextures + 1) );
    ASSERT( pTempTexture );
...
//=====================================================================================================================================
void QPCRipSkin::NewMesh( char* MeshName, xbool EnvMapped, xbool Shadow, xbool Alpha )
{
    // Allocate enough space to store all previously recorded meshes as well as one more.
    PCRipSkinMesh* pTempMeshes;
    PCRipSkinMesh* pNewMeshStorage;
    s32            MeshFlags;
    ...
    {
        PreviousMeshSize += sizeof( PCRipSkinMesh );
        PreviousMeshSize += sizeof( PCSkinD3DVert ) * mpMesh[i].mNVerts;
        PreviousMeshSize += sizeof( PCSkinMorphTarget ) * mpMesh[i].mNMorphTargets;
        PreviousMeshSize += sizeof( PCSkinMorphDelta ) * mpMesh[i].mNMorphDeltas;
    }
    TotalMeshSize = PreviousMeshSize + sizeof( PCRipSkinMesh );

    pTempMeshes = (PCRipSkinMesh*)x_realloc( mpMesh, TotalMeshSize );
    ASSERT( pTempMeshes );
...
//=====================================================================================================================================
void QPCRipSkin::AddVert( t_RipVert& rRipVert )
{
    PCSkinD3DVert*  pTempVerts = NULL;
    PCSkinD3DVert*  pLastVert;
    PCRipSkinMesh*  pLastCreatedMesh;
    ...
    pTempVerts = (PCSkinD3DVert*)x_realloc( pLastCreatedMesh->mpD3DVerts, sizeof( PCSkinD3DVert ) * (CurrentVertCount + 1) );
    ASSERT( pTempVerts );
...
//=====================================================================================================================================
void QPCRipSkin::AddTri( s32 Vert0, s32 Vert1, s32 Vert2, char* pTextureName )
{
    s32             i;
    s32             TriID;
    s32             CurrentTriCount;
    PCRipSkinTri    NewTri;
    PCRipSkinTri*   pTempTris = NULL;
    PCRipSkinMesh*  pLastCreatedMesh;
    PCSkinD3DVert*  pCurrentVertex;
    vector3         Edge1, Edge2;
    ...
    pTempTris = (PCRipSkinTri*)x_realloc( pLastCreatedMesh->mpTris, sizeof( PCRipSkinTri ) * (CurrentTriCount + 1) );
    ASSERT( pTempTris );
...
//=====================================================================================================================================
void QPCRipSkin::NewMorphTarget( char* TargetName )
{
    PCRipSkinMesh*      pLastCreatedMesh;
    PCSkinMorphTarget*  pTempMorphTargets;
    PCSkinMorphTarget*  pLastMorphTarget;
    ...
    pTempMorphTargets = (PCSkinMorphTarget*)x_realloc( pLastCreatedMesh->mpMorphTarget, sizeof( PCSkinMorphTarget ) * (CurrentMorphTargetCount + 1) );
...
//=====================================================================================================================================
void QPCRipSkin::AddMorphDelta( s32 VertID, vector3 Delta )
{
    PCRipSkinMesh*      pLastCreatedMesh;
    PCSkinMorphDelta*   pTempMorphDeltas;
    PCSkinMorphDelta*   pLastMorphDelta;
    ...
    pTempMorphDeltas = (PCSkinMorphDelta*)x_realloc( pLastCreatedMesh->mpMorphDelta, sizeof( PCSkinMorphDelta ) * (CurrentMorphDeltaCount + 1) );
...
//=====================================================================================================================================
void QPCRipSkin::ForceSingleMatrix( void )
{
    u16             MeshID;
    s32             VertexID;
    PCRipSkinMesh*  pCurrentMesh  = NULL;
    PCSkinD3DVert*  pCurrentVerts = NULL;
...
//=====================================================================================================================================
void QPCRipSkin::ForceDoubleMatrix( void )
{
    u16             MeshID;
    s32             VertexID;
    PCRipSkinMesh*  pCurrentMesh  = NULL;
...
//=====================================================================================================================================
void QPCRipSkin::ForceTripleMatrix( void )
{
    u16             MeshID;
    s32             VertexID;
    PCRipSkinMesh*  pCurrentMesh  = NULL;
...
//=====================================================================================================================================
void QPCRipSkin::PrepareStructures( void )
{
...
//=====================================================================================================================================
void QPCRipSkin::DisplayStats( void )
{
    s32             MeshID;
    s32             SubmeshID;
    PCRipSkinMesh*  pCurrentMesh;
    PCSkinSubmesh*  pCurrentSubmesh;
...
//=====================================================================================================================================
void QPCRipSkin::Save( char* pFileName )
{
    X_FILE* SkinFile;
...
//=====================================================================================================================================
void QPCRipSkin::ReWeightToDoubleMatrix( PCSkinD3DVert* pCurrentVert )
{
    s8  i;
    s8  MaxIndex;
    s8  NextMaxIndex;
    ...
    f32 Weight2;
    s8  NMatrices;
    f32 BlendWeights[MAX_PC_MATRICES_PER_VERT];
...
//=====================================================================================================================================
void QPCRipSkin::ReWeightToTripleMatrix( PCSkinD3DVert* pCurrentVert )
{
    u32 i;
    u32 OriginalMatrixCount;
    s8  MatrixOrderByWeight[MAX_PC_MATRICES_PER_VERT];
    s8  TempMatrixIDs[MAX_PC_MATRICES_PER_VERT];
    f32 BlendWeightsIn[MAX_PC_MATRICES_PER_VERT];
    f32 BlendWeightsOut[MAX_PC_MATRICES_PER_VERT];
...
void QPCRipSkin::ReComputeNormals( void )
{
    ...
    PCRipSkinMesh*  pCurrentMesh;
    PCSkinD3DVert*  pCurrentVerts;
    PCRipSkinTri*   pCurrentTris;
...
//=====================================================================================================================================
void QPCRipSkin::BlendVertexNormals( void )
{
    VertList        VList;
...
//=====================================================================================================================================
void QPCRipSkin::DetermineTheTotalSubMeshCount( void )
{
    s32               nTris;
    s32               MeshID, TriID;
    ...
    for( MeshID = 0; MeshID < mNMeshes; MeshID++ )
    {
        ...
        x_qsort( pCurrentTris, nTris, sizeof( PCRipSkinTri ), TriSortCompare );
    ...
    mpSubMesh = (PCSkinSubmesh*)x_malloc( sizeof( PCSkinSubmesh ) * mNSubMeshes );
    ASSERT( mpSubMesh );
...
//=====================================================================================================================================
void QPCRipSkin::SeparateMeshesIntoSubmeshes( void )
{
        ...
        for( SubMeshID = FirstSubMeshID; SubMeshID < MaxSubMeshID; SubMeshID++ )
        {
            ...
            for( StripID = 0; StripID < NStrips; StripID++ )
            {
                ...
                if( StripID < (NStrips - 1) )
                {
                    ...
                    // Now swap around the order (to fix culling) by adding that same vert in again
                    pCurrentMesh->mpIndices[pCurrentMesh->mNIndices] = pStrips[StripID + 1].pVerts[0];
                    pCurrentMesh->mNIndices++;
...
//=====================================================================================================================================
void QPCRipSkin::CalcalateMeshRadius( void )
{
    s32             MeshID;
    s32             VertID;
    f32             CurrentLength;
...
//=====================================================================================================================================
void QPCRipSkin::BuildAndWriteSkinFileHeader( X_FILE* pSkinFile )
{
    ...
    VERIFY( x_fwrite( &SkinFileHeader, sizeof( PCSkinFileHeader ), 1, pSkinFile ) == 1 );
}

//=====================================================================================================================================
void QPCRipSkin::WriteMeshData( X_FILE* pSkinFile )
{
    s32                 MeshID;
    PCRipSkinMesh*      pCurrentMesh;

    PCSkinMeshHeader    MeshFileHeader;
    ...
    for( MeshID = 0; MeshID < mNMeshes; MeshID++ )
    {
        ...
        MeshFileHeader.mVertexDataSize  = sizeof( PCSkinD3DVert ) * pCurrentMesh->mNVerts;
        MeshFileHeader.mNIndices        = pCurrentMesh->mNIndices;
        MeshFileHeader.mIndexDataSize   = sizeof( s16 ) * pCurrentMesh->mNIndices;

        VERIFY( x_fwrite( &MeshFileHeader,           sizeof( PCSkinMeshHeader ),     1, pSkinFile ) );
...
//=====================================================================================================================================
void QPCRipSkin::WriteSubmeshData( X_FILE* pSkinFile )
{
    VERIFY( x_fwrite( mpSubMesh, sizeof( PCSkinSubmesh ), mNSubMeshes, pSkinFile ) );
}


//=====================================================================================================================================
void QPCRipSkin::WriteTextureData( X_FILE* pSkinFile )
{
    VERIFY( x_fwrite( mpTexture, sizeof( PCSkinTexture ), this->mNTextures, pSkinFile ) );
}


//=====================================================================================================================================
void QPCRipSkin::WriteSkeletonData( X_FILE* pSkinFile )
{
    VERIFY( x_fwrite( mpBone, sizeof( PCSkinBone ), mNBones, pSkinFile ) );
}
...
{
    const PCRipSkinTri* LeftTri;
    const PCRipSkinTri* RightTri;

    // Get a local copy of each pointer that's the correct data type.
    LeftTri  = reinterpret_cast< const PCRipSkinTri* >( Left  );
    RightTri = reinterpret_cast< const PCRipSkinTri* >( Right );
