...
//  Tokenizer.hpp
//
//  The tokenizer loads an entire text file into memory and then allows the 
//  user to view the file as a list of tokens rather than characters.  This is
...
xbool TKN_ReadFile       ( tokenizer* Text, const char* Path );    
...
s32   TKN_ReadIntToken   ( tokenizer* Text );
