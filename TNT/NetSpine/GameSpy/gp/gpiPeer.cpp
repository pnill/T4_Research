...
)
{
	...
	SetReceiveBufferSize(peer->sock, 16 * 1024);
	SetReceiveBufferSize(peer->sock, 32 * 1024);
	SetReceiveBufferSize(peer->sock, 64 * 1024);
	SetReceiveBufferSize(peer->sock, 128 * 1024);
	SetReceiveBufferSize(peer->sock, 256 * 1024);
	//SetReceiveBufferSize(peer->sock, 512 * 1024);
	//SetReceiveBufferSize(peer->sock, 1024 * 1024);
	SetSendBufferSize(peer->sock, 16 * 1024);
	SetSendBufferSize(peer->sock, 32 * 1024);
	SetSendBufferSize(peer->sock, 64 * 1024);
	//SetSendBufferSize(peer->sock, 128 * 1024);
	//SetSendBufferSize(peer->sock, 256 * 1024);
	//SetSendBufferSize(peer->sock, 512 * 1024);
	//SetSendBufferSize(peer->sock, 1024 * 1024);

	GetReceiveBufferSize(peer->sock);
	GetSendBufferSize(peer->sock);
