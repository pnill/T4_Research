...
(
	...
	const char * message,  // A message that was passed into peerStartGame().
	void * param  // User-data.
);
...
(
	...
	char * errorString,  // A text string containing the error.
	void * param  // User-data.
);
...
(
	...
	const char * message,  // A string representing the result.
	void * param  // User-data.
);
...
// If the user is in a staging room, he will be removed.
////////////////////////////////////////////////////////
