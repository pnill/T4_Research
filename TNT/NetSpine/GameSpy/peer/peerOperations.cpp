...
)
{
	...
	// Add the callback.
	////////////////////
	piAddConnectCallback(peer, (PEERBool)success, (peerConnectCallback)operation->callback, operation->callbackParam, operation->ID);
...
/* Authenticate CD Key
*********************/
void piAuthenticateCDKeyCallback
(
	CHAT chat,
	int result,
	const char * message,
