#ifndef __XBOX_GEOM_HPP_INCLUDED__
#define __XBOX_GEOM_HPP_INCLUDED__
...
//-------------------------------------------------------------------------------------------------------------------------------------
struct SGeomFileHeader_Multipass
{
    char    Name[MAX_MESH_NAME];    // Name of Geom
    u32     Flags;                  // GEOM_FLAG_xxx bits
    s32     NMeshes;                // Number of Meshes
    ...
    s32     NMaterials;             // Number of Acclaim Materials
    s32     NMatStages;             // Number of Acclaim Material Stages
...
#define VERTEX_FORMAT_XYZ_ARGB_NORM_TEX1 ( D3DFVF_XYZ | D3DFVF_DIFFUSE | D3DFVF_NORMAL | D3DFVF_TEX1 )
struct VertFormat_XYZ_ARGB_NORM_TEX1
{
	vector3 Pos;    // 12 Bytes.
	u32     Color;  // 4  bytes. A << 24 | R << 16 | G << 8 | B
	vector3 Normal; // 12 Bytes.
...
#define VERTEX_FORMAT_XYZ_ARGB_NORM_TEX1_TEX2 ( D3DFVF_XYZ | D3DFVF_DIFFUSE | D3DFVF_NORMAL | D3DFVF_TEX1 | D3DFVF_TEX2 )
struct VertFormat_XYZ_ARGB_NORM_TEX1_TEX2
{
	vector3 Pos;    // 12 Bytes.
    u32     Color;  // 4  Bytes. A << 24 | R << 16 | G << 8 | B
	vector3 Normal; // 12 Bytes.
...
typedef struct SGeomFileHeader_Multipass    t_GeomFileHeader_Multipass;


#endif // __XBOX_GEOM_HPP_INCLUED__