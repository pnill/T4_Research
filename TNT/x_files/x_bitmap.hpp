...
public:
    ...
    void BuildMips            ( s32 NMipsToBuild = 100, xbool bTintMips = FALSE );
    ...
    void* Load      ( X_FILE* fp, void* ContigMemLoc );
#endif
    ...
    xbool   IsPS2Compressed     ( void ) const;
...
protected:
    ...
    enum flags
    {
        ...
        FLAG_DATA_INSYSTEMMEM   = ( 1 << 7 ),
        FLAG_DATA_PS2COMPRESSED = ( 1 << 8 ),
    };
