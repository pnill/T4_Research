...
struct color
{
        ...
        void Saturate    ( f32 Percentage, xbool bSaturateToWhiteIfNeccessary = TRUE );
        void FadeToBlack ( f32 Percentage );
...
#define COLOR_GREEN      ((u32)0xFF00FF00)    
#define COLOR_BLUE       ((u32)0xFFFF0000)    
#define COLOR_YELLOW     ((u32)0xFF00FFFF)    
#define COLOR_AQUA       ((u32)0xFFFFFF00)    
#define COLOR_PURPLE     ((u32)0xFFFF00FF)
#define COLOR_GREY       ((u32)0xFF080808)
