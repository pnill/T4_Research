...
//  x_free.  These allocations are match the system requirements for
//  data alignment.
//
////////////////////////////////////////////////////////////////////////////
...
s32     x_NumBlocksFree         ( s32* pBlockSizes      = NULL,
                                  s32  BlockSizesLength = 0 );
...
////////////////////////////////////////////////////////////////////////////
//
//  FRAGMENTATION tracking assist
//
//  Each entry in the xmem_fraginfo.Pow2Range array is the number of free
//  blocks of a given size.  [x] = 2^x
//
////////////////////////////////////////////////////////////////////////////

struct xmem_fraginfo
{
    s32     Pow2Range[32];      // Stores # of free blocks in a given range
    s32     FreeSpace[32];      // Stores # of bytes held by blocks in range[x]
};

void    x_GetFragmentationInfo  ( xmem_fraginfo* pFI );
void    x_DumpFragmentationInfo ( const char* Filename = NULL );
...
////////////////////////////////////////////////////////////////////////////
    ...
    #define x_calloc(S)                 x_fn_calloc     ( (S),      __FILE__, __LINE__ )
    ...
    #define x_calloc(S)                 x_fn_calloc     ( (S),      "", 0 )
