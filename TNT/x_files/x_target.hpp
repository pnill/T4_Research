...
////////////////////////////////////////////////////////////////////////////
//  On the GameCube(Dolphin) platform, the SDK uses _DEBUG as a debug-
//  release compile-time switch for certain functions.  If X_DEBUG is
//  defined, we will make sure that _DEBUG is defined as well.
////////////////////////////////////////////////////////////////////////////

#if defined( TARGET_DOLPHIN ) && defined( X_DEBUG ) && !defined( _DEBUG )
    #define _DEBUG
#endif
